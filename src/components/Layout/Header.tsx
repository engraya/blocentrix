...
const Header = () => {
  ...
  return (
    <div data-property-1="Desktop" className="w-full rounded-[64px] backdrop-blur-[1.75px] inline-flex flex-col justify-start items-start">
        ...
        <div className="w-full max-w-[1296px] px-4 sm:px-6 flex flex-col justify-start items-start">
          <div className="self-stretch inline-flex justify-between items-center">
              ...
              <div className="hidden lg:inline-flex flex-col justify-start items-start">
                <div className="w-96 inline-flex justify-center items-center gap-4">
                  <button 
                    ...
                    className="flex justify-center items-start hover:text-purple-400 transition-colors duration-200 cursor-pointer"
                  >
                    <div className="flex justify-center items-center">
                      <div className="inline-flex flex-col justify-start items-start">
                        <div className="justify-center text-gray-100 text-base font-normal leading-tight">Home</div>
                      </div>
                    </div>
                  </button>
                  <button 
                    onClick={() => scrollToSection('about')}
                    className="w-16 flex justify-center items-start hover:text-purple-400 transition-colors duration-200 cursor-pointer"
                  >
                    <div className="w-16 flex justify-center items-center">
                      <div className="flex-1 inline-flex flex-col justify-start items-start">
                        <div className="justify-center text-gray-100 text-base font-normal leading-tight">About us</div>
                      </div>
                    </div>
                  </button>
                  <button 
                  ...
                  >
                    <div className="flex justify-center items-center">
                      <div className="inline-flex flex-col justify-start items-start">
                        <div className="justify-center text-gray-100 text-base font-normal leading-tight">Products</div>
                      </div>
                    </div>
                  </button>
                  <button 
                  ...
                  >
                    <div className="flex justify-center items-center">
                      <div className="inline-flex flex-col justify-start items-start">
                        <div className="justify-center text-gray-100 text-base font-normal leading-tight">Why Blockcentrix</div>
                      </div>
                    </div>
                  </button>
                </div>
            ...
            <div className="hidden lg:flex justify-center items-center gap-6">
              <div className="inline-flex flex-col justify-start items-start">
                <Link to="/contact">
                  <div data-:hover="false" data-variant="1" className="w-full max-w-40 px-8 py-3 bg-white rounded-[300px] shadow-[0px_4px_8px_0px_rgba(77,145,225,0.10)] outline outline-1 outline-offset-[-1px] outline-white inline-flex justify-center items-center hover:bg-gray-50 hover:shadow-[0px_6px_12px_0px_rgba(77,145,225,0.15)] transition-all duration-200">
                    <div className="inline-flex flex-col justify-start items-center">
                      <div className="text-center justify-center text-color-green-7 text-base font-semibold leading-tight">Get in touch</div>
                    </div>
                  </div>
                </Link>
              </div>
          ...
          {/* Mobile Menu */}
          {isMenuOpen && (
            <div className="lg:hidden w-full mt-4 bg-white/10 backdrop-blur-md rounded-lg p-4">
              <div className="flex flex-col space-y-4">
                <button 
                  onClick={() => scrollToSection('home')}
                  className="text-gray-100 hover:text-purple-400 transition-colors duration-200 text-left py-2"
                >
                  Home
                </button>
                <button 
                ...
                <div className="pt-2 border-t border-gray-600">
                  <Link to="/contact" onClick={() => setIsMenuOpen(false)}>
                    <div className="w-full px-6 py-3 bg-white rounded-[300px] shadow-[0px_4px_8px_0px_rgba(77,145,225,0.10)] outline outline-1 outline-offset-[-1px] outline-white inline-flex justify-center items-center hover:bg-gray-50 hover:shadow-[0px_6px_12px_0px_rgba(77,145,225,0.15)] transition-all duration-200">
                      <div className="text-center justify-center text-color-green-7 text-base font-semibold leading-tight">Get in touch</div>
                    </div>
                  </Link>
                </div>
